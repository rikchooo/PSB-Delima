...
export default function LoginPage() {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      if (forgotStep === 1) {
        const res = await apiFetch('/api/user/private/forgot-password', {
          method: 'POST',
        ...
        const res = await apiFetch('/api/user/private/verify-otp', {
          method: 'POST',
        ...
        const res = await apiFetch('/api/user/private/reset-password', {
          method: 'POST',
        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 px-4">
          <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <form onSubmit={handleForgotPassword} className="p-6 space-y-4">
              ...
              {forgotStep === 1 && (
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">Email Sesuai Role</label>
                  <div className="relative">
                    <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400">
                      <Mail className="w-5 h-5" />
                    </span>
